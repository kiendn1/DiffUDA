...
class TransferNet(nn.Module):
    ...
    def forward(self, args, source_img, gen_img, target_img, source_label, gen_label, target_strong=None, label_set=None, tgt_index=None, preds_target=None):
        ...
        if not self.args.baseline:
            ...
            if tgt_index is None:
                ...
                target_clip_logits = torch.from_numpy(preds_target[tgt_index.cpu()])
